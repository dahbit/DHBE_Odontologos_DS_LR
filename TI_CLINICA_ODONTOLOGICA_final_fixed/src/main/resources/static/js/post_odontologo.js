...
window.addEventListener('load', function () {
    ...
    formulario.addEventListener('submit', function (event) {
        // Asegúrate de que los campos del formulario coincidan con el HTML
        const formData = {
            paciente: { id: document.querySelector('#pacienteId').value },
            odontologo: { id: document.querySelector('#odontologoId').value },
            fechaHora: document.querySelector('#fechahora').value  // Asegúrate de que el ID sea correcto
        };
    ...
    function resetUploadForm() {
        ...
        document.querySelector('#fechahora').value = "";  // Asegúrate de que el ID sea correcto
    }
